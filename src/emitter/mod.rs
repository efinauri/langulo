...
//                 $self.bytecode.push(Instruction::new($opcode, 0));
//         Ok(())
//     }};
// }
//
...
//             AstNode::LogicalAnd => emit_binary!(self, node, OpCode::And),
//             AstNode::LogicalOr => emit_binary!(self, node, OpCode::Or),
//             AstNode::LogicalXor => emit_binary!(self, node, OpCode::Xor),
//             AstNode::Print => {
